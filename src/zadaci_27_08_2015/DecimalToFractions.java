 ...
 * the number in a fraction. Hint: read the decimal number as a string, extract
 * the integer part and fractional part from the string, and use the BigInteger
 * implementation of the Rational class in Programming Exercise 13.15 to obtain
 * a rational number for the decimal number.
 */
public class DecimalToFractions {
	...
	public static void main(String[] args) {
		...
		if (nums.length > 1) {
			...
			//informing user the number was entered in wrong format probably without a dot
