 ...
 * integers as follows: private long[] r = new long[2]; Use r[0] to represent
 * the numerator and r[1] to represent the denominator. The signatures of the
 * methods in the Rational class are not changed, so a client application that
 * uses the previous Rational class can continue to use this new Rational class
...
class Rational extends Number implements Comparable<Rational> {
	 ...
	 * 
	 * @param n
	 *            - first number we pass to method
	 * @param d
	 *            - second number we pass to method
