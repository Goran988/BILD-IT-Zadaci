 ...
 * public char charAt(int index); public int
 * length(); 
...
public class MyString1 {
	 ...
	 * 
	 * @param begin
	 *            - start of our new array
	 * @param end
	 *            - end index of our new array
	 * @return returns object with new value
	 */
	public MyString1 substring(int begin, int end) {
	...
	/**
	 * method that converts all characters to lower case
	 * 
	 * @return - returns new object with all characters in array as lower case
	 */
	public MyString1 toLowerCase() {
	...
	/**
	 * method that compares "this" object with passed argument
	 * 
	 * @param s
	 *            - MyString1 object that we need to compare
	 * @return - returns true if objects are equal and false if they're not
	 */
	public boolean equals(MyString1 s) {
		boolean res = false;
