 ...
 * Comparable. Draw the UML diagram and implement the compareTo method to
 * compare the circles on the basis of area. Write a test class to find the
 * larger of two instances of ComparableCircle objects.
 */
