 ...
 * larger of two GeometricObject objects. Draw the UML diagram and implement the
 * new GeometricObject class. Write a test program that uses the max method to
