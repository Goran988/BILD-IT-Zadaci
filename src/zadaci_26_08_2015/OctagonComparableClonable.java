 ...
 * Comparable and Cloneable interfaces. Assume that all eight sides of the
 * octagon are of equal length. The area can be computed using the following
 * formula: area = (2 + 4/22)* side * side Write a test program that creates an
 * Octagon object with side value 5 and displays its area and perimeter. Create
...
class Octagon extends GeometricObject implements Cloneable,
	...
	// copare method that uses area to compare which object is bigger
